# Public: Some facts about triangles
#
# side1, side2, and side3 - the Integer side lengths of the triangle
# 
# Example
# 
#   Triangle.new 5, 5, 5
# 
# Returns an instance of Triangle with various helpful methods defined.
