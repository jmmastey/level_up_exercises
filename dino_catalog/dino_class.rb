class Dinos
   ...
   def initialize(dino_data)
      ...
      #Different csv files have different headers (dictionary keys).  We want to translate
      #from the dictionary key into the proper variable.  We translate using the translation
      #dictionary, which maps headers to instance variables. 
      translate = {}
      ...
      #Loop over the dino_data.  Map dino_data key to its corresponding variable name.  Set the corresponding 
      ...
      @dino_diet = (@dino_diet == 'Yes' or @dino_diet == 'Carnivore' or @dino_diet == 'Insectivore') 
   ...
   def print_dino()
      #This function prints out all of the data that was collected about this particular dino
  
      #Dino variables
      dino_variables = ["dino_name", "dino_continent", "dino_period", "dino_diet", "dino_weight", "dino_feet", "dino_description"]
