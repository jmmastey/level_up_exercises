...
describe Bomb do
  ...
  describe "#initialize" do
    ...
    it "has a default deactivation code of 0000" do
      expect(bomb.activation_code).to eq(0)
    end
    ...
    it "must have an integer activation code between 0-9999" do
      ...
      expect { bomb.new(activation_code: "A String") }.to raise_error ArgumentError
    end
    ...
    it "must have an integer deactivation code between 0-9999" do
      ...
      expect { Bomb.new(deactivation_code: "A String") }.to raise_error ArgumentError
    end
  end
end
