...
describe 'the bomb' do
  context 'when initializing' do
    ...
    it 'should default to 1234/0000 as codes when provided invalid codes' do
     ...
     it 'should allow custom activation and deactivation codes' do
       bomb = Bomb.new('4321', '1111')
       expect(bomb.activate('4321')).to eql(true)
       expect(bomb.deactivate('1111')).to eql(true)
     end

     it 'should not allow activation and deactivation codes shorter than 4 characters' do
       bomb = Bomb.new('','')
       expect(bomb.activation_code).to eql('1234')
       expect(bomb.deactivation_code).to eql('0000')
     end
  ...
  context 'when inputting codes' do
    ...
    it 'should do nothing when deactivation code is entered if bomb not active' do
      bomb = Bomb.new
      deactivation = bomb.deactivate('0000')
