...
ActiveRecord::Schema.define(version: 20_141_003_162_254) do
  ...
  add_index "event_dates", ["event_id"],
            name: "index_event_dates_on_event_id",
            using: :btree
  add_index "event_dates", ["venue_id"],
            name: "index_event_dates_on_venue_id",
            using: :btree
  ...
  add_index "venue_events", ["event_dates_id"],
            name: "index_venue_events_on_event_dates_id",
            using: :btree
  add_index "venue_events", ["events_id"],
            name: "index_venue_events_on_events_id",
            using: :btree
  add_index "venue_events", ["venue_id"],
            name: "index_venue_events_on_venue_id",
            using: :btree
