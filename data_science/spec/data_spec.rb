...
describe Data do
  describe "#initialize" do
    xit "must have a cohort name" do
      data = Data.new("A", 0)
      expect(data.cohort).to be("A")
    end

    xit "raises an error if no cohort name" do
      expect { Data.new }.to raise_error ArgumentError
    end

    xit "has a conversion factor of 0 or 1" do
      data0 = Data.new("A", 0)
      data1 = Data.new("A", 1)
    ...
    xit "cannot have a conversion besides 0 or 1" do
