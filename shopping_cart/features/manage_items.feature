Feature: Manage Items
  ...
  Scenario: Add Existing Item By Click
    ...
    Then I see the item in the cart
    And the item quantity is incremented by one
  ...
  Scenario: Remove All of an Item in the Shopping Cart
    ...
    Then I won't see the item in my cart 
