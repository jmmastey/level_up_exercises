...
module WeatherLoader
  ...
  def self.maxt_time_indexes(response, load_params = {})
  ...
  def self.mint_time_indexes(response, load_params = {})
    load_params[:time_value].each_with_object([]) do |(key, value), indexes|
  ...
  def self.cloud_cover_indexes(response, load_params = {})
    load_params[:time_value].each_with_object([]) do |(key, value), indexes|
  ...
  def self.weather_time_indexes(response, load_params = {})
    load_params[:time_value].each_with_object([]) do |(key, value), indexes|
