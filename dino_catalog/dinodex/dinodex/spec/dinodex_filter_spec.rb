...
describe DinodexFilter, "#DinodexFilter" do
  ...
  it "shows all the possible dinosaur attributes to filter on" do
    valid_output = "Keys available: name, period, diet, weight, "\
  ...
  it "filters and prints output in JSON" do
    json_output = '[{"@name":"Abrictosaurus","@period":"Jurassic",' \
      '"@diet":"Herbivore","@weight":"100","@walking":"Biped"}]'
    expect(@output).to receive(:puts).with(json_output)
