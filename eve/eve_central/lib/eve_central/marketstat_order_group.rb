...
module EveCentral
  class MarketstatOrderGroup
    ...
    validates_numericality_of :average, :median,
      greater_than_or_equal_to: :minimum, less_than_or_equal_to: :maximum
    validates_numericality_of :maximum, greater_than_or_equal_to: :minimum
    validates_numericality_of :minimum, :standard_deviation,
      greater_than_or_equal_to: 0
    validates_numericality_of :percentile, greater_than_or_equal_to: 0,
