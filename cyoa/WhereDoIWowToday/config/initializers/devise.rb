...
Devise.setup do |config|
  ...
  # config.secret_key = 'd93ea8b94f1fc73999b5f5dacae8264cd8fb9bbe76b3004c5a03ff44ffb8b09549621180a755bf5c0eebdc37567848fc6ebd8f75ef273892a28cbbd85d4a71d1'
  ...
  # permissions, you should implement that in a before filter.  You
  # can also supply a hash where the value is a boolean determining
  # whether or not authentication should be aborted when the value is
  # not present.  config.authentication_keys = [:email]
  ...
  # environments. Note that, for bcrypt (the default encryptor), the
  ...
  # config.pepper = '606f707a553e192d7630a150d27bf6677e82c2dc2211f7d042fe5a11bc6b44b77b1f85b82cf162c4e24849a592ab23badf7d41a8dc506cd53110438d52d39d0d'
  ...
  # authentication tools as :clearance_sha1, :authlogic_sha512 (then
  # you should set stretches above to 20 for default behavior) and
