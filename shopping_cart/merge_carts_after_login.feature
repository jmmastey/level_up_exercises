Feature: When anonymous user logs in, her cart is merged with her account's saved cart
	...
	Scenario: Anonymous user logs in with items in cart. Her account also has items saved in its cart. Merge the carts
		Given that I am not logged in
		And I have 1 Broomstick and 1 Wand in my cart
		And my account has 2 Broomsticks and 1 Textbook saved in its cart
		When I log in
	...
	Scenario: Anonymous user enters wrong information
		...
		Then I should see 1 Broomstick and 1 Wand