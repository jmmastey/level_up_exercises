...
-- modified_by and created_by can be set to null if the corresponding user is deleted
...
-- Store brewery information. Name and city must not be null. modified_by and created_by
-- may be set to null if the corresponding user has been deleted.
...
-- modified_by and created_by may be set to null if the corresponding user is deleted.
...
-- overall are integers between 1 and 10. modified_by and created_by may be set
-- to null if the corresponding user has been deleted.
