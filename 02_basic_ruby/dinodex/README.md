...
1. I loaded my favorite dinosaurs into a CSV file you'll need to parse. I don't know a lot about African Dinosaurs though, so I downloaded one from The Pirate Bay. It isn't formatted as well as mine, but please try to parse it anyway.
	fields:
		dinodex.csv:	NAME	PERIOD	CONTINENT	DIET	WEIGHT_IN_LBS	WALKING	DESCRIPTION
		african_dinosaur_export.csv:	Genus	Period	Carnivore	Weight	Walking
...
main()
 - load files
 - create collection of dinosoaurs
 - allow filtering
	- interactive?
 - display single
 - diplsay multiple
