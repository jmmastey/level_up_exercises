...
ActiveRecord::Schema.define(version: 20_141_202_180_723) do
  ...
  add_index "pages", %w(content_id content_type), name: "index_pages_on_content_id_and_content_type", using: :btree
  ...
  add_index "quiz_activities", %w(question_id question_type), name: "index_quiz_activities_on_question_id_and_question_type", using: :btree
