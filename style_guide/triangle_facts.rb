...
class Triangle
	...
	def calculate_angles(a, b, c)
		...
		aR = Math.acos((b2 + c2 - a2) / (2.0 * b * c))
		bR = Math.acos((a2 + c2 - b2) / (2.0 * a * c))
		cR = Math.acos((a2 + b2 - c2) / (2.0 * a * b))

		angleA = radians_to_degrees(aR)
		angleB = radians_to_degrees(bR)
		angleC = radians_to_degrees(cR)
